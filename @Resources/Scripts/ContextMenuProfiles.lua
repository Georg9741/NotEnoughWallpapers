function Initialize()
  ...
  for n=1,num do
    ...
    table.insert(t, 'Context'..n..'Action3=[!ActivateConfig "#ROOTCONFIG#\\Settings"][!CommandMeasure Focus "#ROOTCONFIG#\\Settings"][!DeactivateConfig "#ROOTCONFIG#\\Settings\\Minimized"]')
    table.insert(t, 'Context'..n..'Title4=-')
    table.insert(t, 'Context'..n..'Title5=Detect Preview')
    table.insert(t, 'Context'..n..'Action5=[!CommandMeasure PreviewPathMeasure Run][!SetVariable Path '..n..'][!WriteKeyValue '..n..' MeasureName PreviewImageMeasure'..n..' "#@#PreviewIncMeasures.inc"]')
    table.insert(t, 'Context'..n..'Title6=Set NoImage.png')
    table.insert(t, 'Context'..n..'Action6=[!WriteKeyValue '..n..' MeasureName "" "#@#PreviewIncMeasures.inc"][!Refresh]')
